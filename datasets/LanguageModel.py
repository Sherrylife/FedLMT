...
# from utils import check_exists, makedir_exist_ok, save, load, download_url, extract_file
from utils import check_exists, makedir_exist_ok, save, load, download_url, extract_file
...
class WikiText2(LanguageModeling):
    ...
    file = [('https://github.com/Snail1502/dataset_d2l/blob/main/wikitext-2-v1.zip', None)]
