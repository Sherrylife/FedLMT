...
def generate_svhn(dir_path, args):
    ...
    dataset = {}
    dataset['train'] = datasets.SVHN(root=dir_path + "rawdata", download=True, split='train',
                                        transform=transforms.Compose([
                                            # transforms.RandomCrop(32, padding=2),
                                            # transforms.RandomHorizontalFlip(),
                                            transforms.ToTensor(),
                                            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]))
    dataset['test'] = datasets.SVHN(root=dir_path + "rawdata", download=True, split='test',
                                       transform=transforms.Compose([
