...
@ray.remote(num_gpus=0.2, num_cpus=0.5)
class clientFedLMT(ClientBase):
    ...
    def calculate_smallest_svdvals(self, client_LR_ratio, client_id, model_id):
        """
        Calculate the smallest singular value of clients' local model
        :return:
        """
        ...
        p_model.eval()
        svd_vals = p_model.cal_smallest_svdvals()
        return np.min(svd_vals)
